...
<body>
	...
	<div class="container">
		<form action="join" method="post" onsubmit="return validateForm()">
			...
			<span id="idCheckResult"></span><br> PW:<br> <input
				type="text" name="userPW"><br> EMAIL:<br> <input
				type="text" name="userEmail"><br> 이름:<br> <input
				type="text" name="userName"><br> 번호:<br> <input
				type="text" name="userNumber"><br>
			<div class="select">
				<input type="radio" id="customer" name="role" value="customer"
					checked> <label for="customer">손님</label> <input
					type="radio" id="owner" name="role" value="owner"> <label
					for="owner">사장님</label>
			</div>
