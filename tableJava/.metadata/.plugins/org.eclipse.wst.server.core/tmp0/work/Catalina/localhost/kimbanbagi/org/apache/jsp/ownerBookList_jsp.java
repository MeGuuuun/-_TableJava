 ...
 * Generated at: 2024-06-17 07:18:21 UTC
...
public final class ownerBookList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("// 예약 확정 처리 ajax\r\n");
      out.write("function confirmStatus(rId, bId, rName, uId) {\r\n");
      out.write("	var status = \"1\";\r\n");
      out.write("	var restaurantId = rId;\r\n");
      out.write("	var bookId = bId; //예약한 사용자의 ID\r\n");
      out.write("	var restaurantName = rName;\r\n");
      out.write("	var userId = uId; // 사장님의 ID\r\n");
      out.write("	\r\n");
      out.write("	var cbutton = document.getElementById(\"confirmBtn\");\r\n");
      out.write("	var ebutton = document.getElementById(\"endBtn\");\r\n");
      out.write("	\r\n");
      out.write("	$.ajax({\r\n");
      out.write("        type: \"POST\",\r\n");
      out.write("        url: \"OwnerBookList\",\r\n");
      out.write("        data: { action: \"status\", status: status, userId : userId, restaurantId : restaurantId, restaurantName : restaurantName, bookId : bookId },\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("// 예약 종료 처리 ajax\r\n");
      out.write("function endStatus(rId, bId, rName, uId){\r\n");
      out.write("	var status = \"4\";\r\n");
      out.write("	var restaurantId = rId;\r\n");
      out.write("	var bookId = bId;\r\n");
      out.write("	var restaurantName = rName;\r\n");
      out.write("	var userId = uId;\r\n");
      out.write("	\r\n");
      out.write("	var button = document.getElementById(\"endBtn\");\r\n");
      out.write("	\r\n");
      out.write("	$.ajax({\r\n");
      out.write("        type: \"POST\",\r\n");
      out.write("        url: \"OwnerBookList\",\r\n");
      out.write("        data: { action: \"status\", status: status, userId : userId, restaurantId : restaurantId, restaurantName : restaurantName, bookId : bookId },\r\n");
      out.write("        success: function(response) {\r\n");
      out.write("        	alert(\"예약 종료되었습니다.\");\r\n");
      out.write("            window.location.reload();\r\n");
      out.write("        },\r\n");
      out.write("        error: function() {\r\n");
      out.write("            alert(\"예약 종료에 실패했습니다. 다시 시도해주세요.\");\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("// 예약 취소 처리 ajax\r\n");
      out.write("function cancelStatus(rId, bId, rName, uId) {\r\n");
      out.write("    var status = \"3\";\r\n");
      out.write("    var restaurantId = rId;\r\n");
      out.write("   	var bookId = bId;\r\n");
      out.write("    var restaurantName = rName;\r\n");
      out.write("    var userId = uId;\r\n");
      out.write("    \r\n");
      out.write("    var button = document.getElementById(\"cancelBtn\");\r\n");
      out.write("   \r\n");
      out.write("    $.ajax({\r\n");
      out.write("        type: \"POST\",\r\n");
      out.write("        url: \"OwnerBookList\",\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${restaurantId }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("            	<button type=\"submit\" name=\"action\" value=\"ownerNotification\">알림 화면</button>\r\n");
      out.write("            </form>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${restaurantId }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("            	<button type=\"submit\" name=\"action\" value=\"getOwnerInfo\">마이 페이지</button>\r\n");
      out.write("            </form>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div>\r\n");
      out.write("    	<button onclick=\"location.reload()\">예약 내역</button>\r\n");
      out.write("    	<form method=\"post\" action=\"OwnerWaitList\">\r\n");
      out.write("    		<input type=\"hidden\" name=\"userId\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userId }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("    		<input type=\"hidden\" name=\"restaurantId\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${restaurantId }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("    		<button type=\"submit\" name=\"action\" value=\"waitList\">웨이팅 내역</button>\r\n");
      out.write("    	</form>\r\n");
      out.write("    </div>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /ownerBookList.jsp(117,2) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/ownerBookList.jsp(117,2) '${bookList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${bookList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /ownerBookList.jsp(117,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /ownerBookList.jsp(129,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.status ==  '예약 대기'}", boolean.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /ownerBookList.jsp(137,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.status ==  '예약 확정'}", boolean.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      int _jspx_eval_c_005fif_005f1 = _jspx_th_c_005fif_005f1.doStartTag();
      if (_jspx_eval_c_005fif_005f1 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("					<div>\r\n");
          out.write("						<button type=\"button\" onclick=\"endStatus('");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${restaurantId}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("', '");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.user_id }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("', '");
          ...
          out.write("', '");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${userId }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("')\" id=\"endBtn\">예약 종료</button>\r\n");
          out.write("					</div>\r\n");
          out.write("					<div>\r\n");
          out.write("						<button type=\"button\" disabled>예약 취소</button>\r\n");
          out.write("					</div>\r\n");
          out.write("				");
  ...
  private boolean _jspx_meth_c_005fif_005f2(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /ownerBookList.jsp(145,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.status ==  '예약 종료' || book.status == '예약 취소' || book.status == '예약 거절'}", boolean.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
